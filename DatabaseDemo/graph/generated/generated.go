...
type MutationResolver interface {
	...
	UpdateStudent(ctx context.Context, input model.UpdateStudent) (*model.Student, error)
}
type QueryResolver interface {
	Student(ctx context.Context) ([]*model.Student, error)
}
...
func (ec *executionContext) field_Mutation_createStudent_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewStudent2databasedemoᚋgraphᚋmodelᚐNewStudent(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateStudent_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNUpdateStudent2databasedemoᚋgraphᚋmodelᚐUpdateStudent(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createStudent(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNStudent2ᚖdatabasedemoᚋgraphᚋmodelᚐStudent(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateStudent(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateStudent(rctx, args["input"].(model.UpdateStudent))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_student(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Student(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*model.Student)
	fc.Result = res
	return ec.marshalNStudent2ᚕᚖdatabasedemoᚋgraphᚋmodelᚐStudentᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNNewStudent2databasedemoᚋgraphᚋmodelᚐNewStudent(ctx context.Context, v interface{}) (model.NewStudent, error) {
...
func (ec *executionContext) marshalNStudent2databasedemoᚋgraphᚋmodelᚐStudent(ctx context.Context, sel ast.SelectionSet, v model.Student) graphql.Marshaler {
	return ec._Student(ctx, sel, &v)
}

func (ec *executionContext) marshalNStudent2ᚕᚖdatabasedemoᚋgraphᚋmodelᚐStudentᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Student) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNStudent2ᚖdatabasedemoᚋgraphᚋmodelᚐStudent(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNStudent2ᚖdatabasedemoᚋgraphᚋmodelᚐStudent(ctx context.Context, sel ast.SelectionSet, v *model.Student) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNUpdateStudent2databasedemoᚋgraphᚋmodelᚐUpdateStudent(ctx context.Context, v interface{}) (model.UpdateStudent, error) {
